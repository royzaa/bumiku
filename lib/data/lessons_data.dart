...
''',
      name: 'Lapisan penyusun bumi',
    ),
    LapisanBumi(
      content: '''1.	Lapisan Inti Bumi
...
''',
      name: 'Lapisan inti bumi',
    ),
    LapisanBumi(
      content: '''2.	Lapisan Mantel Bumi
...
''',
      name: 'Lapisan mantel bumi',
    ),
    LapisanBumi(
      content: '''3.	Lapisan Kulit Bumi
...
''',
      name: 'Lapisan kulit bumi',
    ),
  ],
  atmosferLitosfer: [
    AtomsferLitosfer(
      content: '''Lapisan Litosfer Bumi
...
''',
      name: 'Lapisan litosfer bumi',
    ),
    AtomsferLitosfer(
      content: '''Lapisan Atmosfer Bumi
...
''',
  ...
  gunungApi: [
    ...
    GunungApi(
      content: '''Klasifikasi Berdasarkan Bentuk Gunung Api
...
''',
      name: 'Klaisifikasi gunung api berdasarkan bentuknya',
    ),
    GunungApi(
      content: '''Klasifikasi Berdasarkan Letusan Gunung Api
...
''',
      name: 'Klaisifikasi gunung api berdasarkan letusannya',
    ),
    GunungApi(
      content: '''Proses Terbentuknya Gunung Api
...
''',
      name: 'Proses terbentuknya gunung api',
    ),
    GunungApi(
      content: '''Gempa Bumi
...
''',
    ...
    GunungApi(
      content: '''Macam-macam Gempa Bumi :
...
''',
      name: 'Macam gempa bumi',
    ),
    GunungApi(
      content: '''Pergerakan Lempeng
...
''',
      name: 'Pergerakan lempeng',
    ),
    GunungApi(
      content: '''Lipatan dan Patahan
